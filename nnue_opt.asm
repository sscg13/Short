...
; =====================================================================
; nn_fwd_eval8_ - exact ReLU^2 forward for blob-v4's eight material
; output buckets. Its x32 weights are restricted to [-64,63], so one
; 64-KB signed table directly stores (activation^2*weight)>>8. This
; removes v3's sign branches and negative-rounding correction.
